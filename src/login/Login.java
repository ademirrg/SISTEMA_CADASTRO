	...
	public void pegaValorTela() throws NoSuchAlgorithmException, UnsupportedEncodingException {
		...
		// Se todos os campos estiverem ok
			...
			if (user.equalsIgnoreCase(NomeUserVO) == false) {
				System.out.println(
						"Tentativa de login com o usuário " + user.toUpperCase() + ", usuário náo cadastrado.");
...
//			break;
		...
		case COMMAND_ALTERAR_SEGMENTO:
			...
			break;
		case COMMAND_INFO:
			JOptionPane.showMessageDialog(null, "Versão: 0.1" + System.lineSeparator() +
					"Data de criação: 09/02/2017" + System.lineSeparator() +
					"Criado por: Ademir Rocha", "SOBRE",JOptionPane.INFORMATION_MESSAGE);
			break;
		}
